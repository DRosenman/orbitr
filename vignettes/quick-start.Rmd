...
Printing a system shows the gravitational constant it uses and a tibble of the bodies in it:
...
`get_bodies()` returns that bodies tibble directly, so you can filter, inspect, or save it without reaching into the object's internals:
