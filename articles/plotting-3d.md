...
If `plotly` isn’t installed, the function warns you and falls back to
the 2D plot even for 3D data.
...
This gives you the same rotation and zoom controls, even though all the
Z values are zero.
