...
- **Three or more bodies.** Chaos is the natural state of N-body systems. The stable examples in this README are carefully tuned — don't expect random configurations to behave.
...
The semi-major axis is the single most characteristic length scale of an elliptical orbit. It determi
