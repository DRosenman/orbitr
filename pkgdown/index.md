...
![Closed elliptical trajectory of Earth orbiting the Sun over one year](man/figures/README-sun-earth-plot-with-sun-1.png)
...
> `orbitr` is under active development. The physics engine is stable, but the API may evolve. Feedback and contributions are welcome on [GitHub](https://github.com/DRosenman/orbitr).
